...
def random_apply_affine(img, p, G=None, antialiasing_kernel=SYM6):
    ...
    img_2x = upfirdn2d.upfirdn2d(
        img_pad, kernel.unsqueeze(0), up=(2, 1), padding=(*up_pad[:2], 0, 0)
    )
    img_2x = upfirdn2d.upfirdn2d(
        img_2x, kernel.unsqueeze(1), up=(1, 2), padding=(0, 0, *up_pad[2:])
    )
    ...
    grid_sample = _GridSample2dForward.apply
